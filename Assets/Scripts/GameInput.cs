...
namespace Sanicball
{
    public static class GameInput
    {
        ...
        public static Vector3 MovementVector(ControlType ctrlType)
        {
            ...
            {
                case ControlType.Keyboard:
                    bool forward = Input.GetKey(ActiveData.Instance.Keybinds[Keybind.Forward]) && !KeyboardDisabled;
                    bool left = Input.GetKey(ActiveData.Instance.Keybinds[Keybind.Left]) && !KeyboardDisabled;
                    bool back = Input.GetKey(ActiveData.Instance.Keybinds[Keybind.Back]) && !KeyboardDisabled;
                    bool right = Input.GetKey(ActiveData.Instance.Keybinds[Keybind.Right]) && !KeyboardDisabled;
        ...
        public static Vector2 CameraVector(ControlType ctrlType)
        {
            ...
            {
                case ControlType.Keyboard:
                    bool up = Input.GetKey(ActiveData.Instance.Keybinds[Keybind.CameraUp]) && !KeyboardDisabled;
                    bool left = Input.GetKey(ActiveData.Instance.Keybinds[Keybind.CameraLeft]) && !KeyboardDisabled;
                    bool down = Input.GetKey(ActiveData.Instance.Keybinds[Keybind.CameraDown]) && !KeyboardDisabled;
                    bool right = Input.GetKey(ActiveData.Instance.Keybinds[Keybind.CameraRight]) && !KeyboardDisabled;
        ...
        public static bool IsBraking(ControlType ctrlType)
        {
            ...
            {
                case ControlType.Keyboard:
                    return Input.GetKey(ActiveData.Instance.Keybinds[Keybind.Brake]) && !KeyboardDisabled;
        ...
        public static bool IsJumping(ControlType ctrlType)
        {
            ...
            {
                case ControlType.Keyboard:
                    return Input.GetKeyDown(ActiveData.Instance.Keybinds[Keybind.Jump]) && !KeyboardDisabled;
        ...
        public static bool IsRespawning(ControlType ctrlType)
        {
            ...
            {
                case ControlType.Keyboard:
                    return Input.GetKeyDown(ActiveData.Instance.Keybinds[Keybind.Respawn]) && !KeyboardDisabled;
        ...
        public static bool IsOpeningMenu(ControlType ctrlType)
        {
            ...
            {
                case ControlType.Keyboard:
                    return Input.GetKeyDown(ActiveData.Instance.Keybinds[Keybind.Menu]) && !KeyboardDisabled;
        ...
        {
            return (Input.GetKeyDown(ActiveData.Instance.Keybinds[Keybind.NextSong]) && !KeyboardDisabled) || Input.GetKeyDown(KeyCode.JoystickButton6);
        }

        public static bool IsOpeningChat()
        {
            return Input.GetKeyDown(ActiveData.Instance.Keybinds[Keybind.Chat]) && !KeyboardDisabled;
        }
