...
namespace Sanicball.UI
{
    ...
    public class LocalPlayerPanel : MonoBehaviour
    {
        ...
        {
            string kbConfirm = GameInput.GetKeyCodeName(ActiveData.singleton.keybinds[Keybind.Menu]);
            const string joyConfirm = "X";
            string kbAction = GameInput.GetKeyCodeName(ActiveData.singleton.keybinds[Keybind.Respawn]);
